<p align="center">
  <a href="https://www.aichner-christian.com/" target="_blank" rel="noopener noreferrer">
    <img src="https://www.aichner-christian.com/img/logo/apilink_sm.png" alt="Api Link Logo" height="150">
  </a>
</p>
...
<p align="center">
  ...
  <br>
  <br>
  <a href="https://github.com/api-link/Front/issues/new?template=bug_report.md">Report bug</a>
  ·
  <a href="https://github.com/api-link/Front/issues/new?template=feature_request.md">Request feature</a>
  ·
  <a href="https://www.aichner-christian.com/damn/dev">Blog</a>
  <br>
  <br>
  <a href="https://www.codacy.com/app/api-link/Front">
...
- Clone the repository: `git clone https://github.com/api-link/Front.git api-link`
- Go to the new folder `cd api-link`
- Run `npm install`
...
addressed yet, [please open a new issue](https://github.com/api-link/Front/issues/new/choose).

## [](#contributing)Contributing

![GitHub last commit](https://img.shields.io/github/last-commit/api-link/Front)
![GitHub issues](https://img.shields.io/github/issues-raw/api-link/Front)
![GitHub closed issues](https://img.shields.io/github/issues-closed-raw/api-link/Front?color=green)

Please read through our
[contributing guidelines](https://github.com/api-link/Front/blob/master/CONTRIBUTING.md). Included are
...
![GitHub package.json version](https://img.shields.io/github/package-json/v/api-link/Front)
